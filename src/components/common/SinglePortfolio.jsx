         ...
         <div className='flex justify-between flex-wrap'>
            {
                Portfolio.map((item,i)=>{
                    return(
                        <div key={i} className='bg-[#0e0d0d] py-[30px] px-[20px] w-[500px] rounded-[20px] mt-[10px]'>
                            <div className="img">
                                {item.Img}
                            </div>

                            <h2 className='text-[22px] font-montserrat font-semibold text-white my-6'>{item.portName}</h2>
