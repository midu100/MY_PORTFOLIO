...
const SingleService = ({Icon,Namee,para,}) => {
  return (
    <>
        <div className='bg-[#1d1c1c] w-[500px] px-[20px] py-[30px] rounded-[20px] border border-gray-500 mt-[10px] hover:shadow-[0px_3px_33px_-4px_rgba(234,_179,_8,_0.5)] duration-400'>
